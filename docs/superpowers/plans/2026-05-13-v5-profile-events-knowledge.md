...
6. **DEFAULT_PROJECT_ID (00000000-…)** — это Moorinet 2.0. Если backfill для него запустить, разрушит ту команду. Решение: backfill вручную, по проекту, с подтверждением.
