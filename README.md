...
MCP сервер для централизованной командной памяти проекта **Project 2.0**. Позволяет всем агентам Claude Code в команде обмениваться информацией о состоянии проекта в реальном времени.
...
```json
{
  "mcpServers": {
    "team-memory": {
      "command": "node",
      "args": ["D:/Project 2.0/team-memory-mcp/dist/index.js"]
    }
  }
}
```
